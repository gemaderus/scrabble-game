var Board = function() {
  ...
  this.length = 32;
  this.level = 0;
  this.wordsList = ["CASA", "CARA", "CANA", "PERRO", "LETRAS", "DODA", "PERA", "LECHE", "ZUMO", "COLA", "MANO", "MESA", "COCHE", "MOTO", "NIÑO", "PLATANO", "PINO", "CALLE", "MANO", "PIE", "DEDO", "OJO", "CIELO", "LUNA", "SOL", "ROCA", "LIMON", "SANDIA", "NUBE", "PERO", "POMO", "LAPIZ", "PAPEL", "PALO", "PELO", "PILA", "POLO", "NUEZ", "NANA", "NENE", "NUEVO", "PICO", "HUEVO", "MIEL", "ABRIGO", "ABUELA", "ABUELO", "AGUA", "ALIMENTOS", "ALMOHADA", "AMARILLO", "AMIGO", "ARBOL", "AUTOMOVIL", "AVION", "AZUL", "BAÑERA", "BARCO", "BEBE", "BEBER", "BIBERON", "BOSTEZAR", "LLUVIA", "CABALLO", "CABRA", "CAMINAR", "CAMION", "BOMBEROS", "CASA", "CEPILLO", "CIELO", "COCHE", "COLORES", "COMER", "CUNA", "DUCHA", "DEDO", "DIAMANTE", "FLOR", "FRESA", "GATO", "GALLETA", "GEMA", "GORRO", "GRACIAS", "HERMANO", "HERMANA", "HOJA", "COMER", "CAMA", "BAÑO", "JUGAR", "JUGUETES", "LAMPARA", "LAPICES", "LEER", "LIBRO", "LLAVES", "LLORAR", "LUZ", "MAMA", "MADRE", "MANZANA", "MARIPOSA", "MARRON", "MEDIAS", "MESA", "MOTOCICLETA", "NARANJA", "OSO", "ORDENADOR", "PELUCHE", "PADRE", "PANTALONES", "PANTUFLAS", "PASTO", "PATO", "PAPA", "PATATA", "PELOTA", "PERA", "PERRO", "PEZ", "PIJAMA", "POLLO", "PUERTA", "QUESO", "RANA", "REIR", "RELOJ", "ROJO", "ROPA", "ROSA", "ROMPECABEZAS", "SENTARSE", "SILLA", "TAZA", "TAZON", "TELEFONO", "TELEVISION", "TIA", "TIO", "TITA", "TITO", "TOALLA", "TOMATE", "TENEDOR", "TREN", "TRICICLO", "VENTANA", "VERDE", "VESTIDO", "VIOLETA", "YO", "ZANAHORIA"];
  this.wordsSelected = [];
};
